...
const web = {
  url: 'https://www.health4spain.com/es',
  folder: 'health4spain-marketplace-extranjeros',
  name: 'Health4Spain'
};
...
async function main() {
  console.log('Capturando Health4Spain...\n');
  ...
  if (closed) {
    ...
    console.log('No se encontro banner de cookies');
  }
  ...
  await page.close();
  await browser.close();
  console.log('\nCapturas de Health4Spain completadas!');
}
